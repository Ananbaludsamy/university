        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="font-weight: bold;">ໃຫ້ຄະແນນ</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                                    ...
                                    ?>
                                        <div class="col-lg-4 col">
                                            ...
                                            <div class="small-box bg-info">
                                                ...
                                                <a href="tb_course1.php?id=<?php echo $row['classid'] ?>" class="small-box-footer">ເບິ່ງທັງໝົດ<i class="fas fa-arrow-circle-right"></i></a>
                                            </div>
                                        </div>
                                    <?php
                                    }
