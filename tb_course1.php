            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-primary">
                        ...
                        <div class="brder" style="margin-top: 20px;"></div>
                        <form method="post">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal<?php echo $row['stid']; ?>">ໃຫ້ຄະແນນ</button></td>
                                                            </tr>
                                                        <?php
                                                        include "components/modal/course/edit-modal-course.php";
                                                        }
                                                        ?>
                                                    </tbody>
                                                </table>
